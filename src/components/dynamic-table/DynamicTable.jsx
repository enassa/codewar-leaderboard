...
export default function DynamicTable({
  ...
  const ejectSorters = () => {
    ...
    return filterForSorters?.map((item, index) => {
      return (
        <option className="text-blue-900" key={index}>
    ...
    <div className="w-full h-full flex flex-col">
      ...
      {!hideActionBar && (
        <div className="w-full">
          <div className=" flex justify-between h-[60px]  items-center mb-[10px]  rounded-md">
            <div className="flex items-center">
              <span className="mr-2  text-[#364E62] text-xl ">Filter by |</span>
              <select
                className="cursor-pointer text-xl capitalize outline-none bg-transparent text-blue-900"
                onChange={(e) => {
            ...
            <div className="flex justify-end items-center">
              <div className="mr-2">
                ...
                <select
                  ...
                  className="cursor-pointer text-xl capitalize text-blue-900 outline-none bg-transparent "
                >
                  {ejectSearchFilters()}
                </select>
              </div>
